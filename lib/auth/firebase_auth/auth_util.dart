...
DocumentReference? get currentUserReference =>
    loggedIn ? BookmarksRecord.collection.doc(currentUser!.uid) : null;

BookmarksRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : BookmarksRecord.getDocument(BookmarksRecord.collection.doc(uid))
              .handleError((_) {}),
    )
