...
import 'modal_post_model.dart';
export 'modal_post_model.dart';

class ModalPostWidget extends StatefulWidget {
  const ModalPostWidget({
    super.key,
    this.postDocument,
  });
...
class _ModalPostWidgetState extends State<ModalPostWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalPostModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          borderWidth: 1.0,
                          buttonSize: 44.0,
                          fillColor: FlutterFlowTheme.of(context).overlayColor,
                          icon: Icon(
                            Icons.close_rounded,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '3qeditr0' /* okay wow, you could definitely... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '776x1nph' /* Incredible work my friend. */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Image.network(
                                            'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjN8fHByb2ZpbGV8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60',
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                        Expanded(
